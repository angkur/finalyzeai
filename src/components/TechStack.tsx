      ...
      <div className="container relative z-10 px-4 sm:px-6">
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 max-w-4xl mx-auto">
          {technologies.map((tech, index) => (
            <div
              key={tech.name}
              className="group relative px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 md:py-4 rounded-lg sm:rounded-xl bg-gradient-card border border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-glow cursor-default"
            >
        ...
        <div className="mt-12 sm:mt-16 md:mt-20 grid grid-cols-3 gap-3 sm:gap-6 md:gap-8 max-w-4xl mx-auto">
          <div className="text-center p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl bg-secondary/30 border border-border/30">
